...
<div class="container mx-auto">
      <div class="flex w-full h-screen items-center antialiased">
        ...
        <div class=" text-right pr-4 w-1/2 font-black uppercase text-[104px] leading-[5.5rem] font-extrabold">
          <h2 class="text-[#490355] animate__faster animate__animated animate__fadeInDown">Who</h2>
          <h2 class="text-[#490355] animate__fast animate__animated animate__fadeInDown">We</h2>
          <h2 class="stroke  text-[#ff6720] animate__slow animate__animated animate__fadeInDown">Are</h2>
        </div>
