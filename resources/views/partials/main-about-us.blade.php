  ...
  <div class="container mx-auto">
    <div class="flex w-full h-screen items-center antialiased">
      <div class=" text-right pr-4 w-1/2 font-black uppercase text-[104px] leading-[5.5rem] font-extrabold">
        <h2 class="about-us-content text-[#490355] animate__faster animate__animated opacity-0"><?php echo get_field('title_first_line') ?></h2>
        <h2 class="about-us-content text-[#490355] animate__fast animate__animated opacity-0"><?php echo get_field('title_second_line') ?></h2>
        <h2 class="about-us-content stroke  text-[#ff6720] animate__slow animate__animated opacity-0"><?php echo get_field('title_third_line') ?></h2>
      </div>
