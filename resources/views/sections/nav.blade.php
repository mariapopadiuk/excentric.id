  ...
  <ul class="w-9/12 m-auto mt-44 relative antialiased">
    <li class="flex">
      <div class="nav-title w-1/2">
        <a class="hover:text-[#ff6720] hover:underline cursor-pointer uppercase"><span
            class="flex justify-center text-7xl font-medium text-white">Who we are.</span></a>
      </div>
    ...
    <li class="flex">
      <div class="nav-title   w-1/2">
        <a class="hover:text-[#ff6720] hover:underline cursor-pointer uppercase"><span
            class="flex justify-center text-7xl font-medium text-white">Clients.</span></a>
      </div>
    ...
    <li class="flex">
      <div class="nav-title   w-1/2">
        <a class="hover:text-[#ff6720] hover:underline cursor-pointer uppercase"><span
            class="flex justify-center text-7xl font-medium text-white">Services</span></a>
      </div>
      <div class="nav-content w-1/2 pl-28 text-2xl text-white whitespace-normal absolute right-0 top-0">
    ...
    <li class="flex">
      <div class="nav-title   w-1/2">
        <a class="hover:text-[#ff6720] hover:underline cursor-pointer uppercase"><span
            class="flex justify-center text-7xl font-medium text-white">Contacts.</span></a>
      </div>
      <div class="nav-content w-1/2 pl-28 text-2xl text-white whitespace-normal absolute right-0 top-0">
